...
extracted from https://github.com/dev4Agriculture/isoxml-js/blob/master/src/DDEntities.ts
"""
import json
...
path = path / 'resources' / 'ddi_update' / 'ddi_entities.json'

with open(path, "r", encoding="utf-8") as json_file:
    _dd_entities = json.load(json_file)
